...
const Share = ({ route }: any) => {
  ...
  return (
    <Screen>
      <HeaderTitle title={"Share receipt"} history={"Done"} />
      <View style={styles.top} className="my-auto flex h-4/5 justify-center ">
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title} className="text-[18px]">
            Transfer Successful!
          </Text>
        </View>
        ...
        <View className=" mt-auto flex flex-row  relative justify-between   w-full p-2">
          <TouchableOpacity
            style={{ flex: 1 }}
            className="bg-[#F8F8FA] rounded w-6/12 h-[100px] items-center flex flex-col justify-center p-2 mr-1"
            onPress={handleModal}
          >
          ...
          <TouchableOpacity
            style={{ flex: 1 }}
            className="bg-[#F8F8FA] rounded w-6/12 h-[100px] p-2 items-center flex flex-col justify-center ml-1"
          >
            <MaterialCommunityIcons
